...
6. Share (public, opt-in)
   → Generic, always-positive shareable image (see §6)
```
...
### 6.1 Primary — "The Best Advice I Got"
```
...
### 6.2 Secondary — "Your Spirit Judge"
```
I think most like...
CAT WU
...
### 8.1 Pre-computed (built once, before app runs)
...
### 8.2 Authored (hand-written, with LLM assistance)
...
### 8.3 Runtime (per round, ~6-8 seconds total)
...
## 9. Tech Stack (recommended, not prescribed)
